...
{
    public static HtmlString CreateUserCourse(this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, Programmania.ViewModels.UserCourseVM course)
    {
    ...
    public static HtmlString CreateCourse(this Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper html, Programmania.ViewModels.UserCourseVM course)
    {
        System.Text.StringBuilder @string = new System.Text.StringBuilder();
        @string.AppendLine("<a>");
        @string.AppendLine("<div class='course'>");
